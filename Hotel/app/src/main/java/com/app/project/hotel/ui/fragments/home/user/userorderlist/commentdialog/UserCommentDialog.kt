package com.app.project.hotel.ui.fragments.home.user.userorderlist.commentdialog
...
import com.app.project.hotel.ui.view.dialog.showCommentUpLoadProcess
import com.example.uitraning.util.Utils
import com.github.gzuliyujiang.wheelpicker.OptionPicker
import com.jakewharton.rxbinding3.view.clicks

@RequiresApi(Build.VERSION_CODES.O)
fun UserOrderListFragment.showCommentDialog(data: UserOrderListDataModel.Data, position: Int) {
    ...
    dialog.binding.btnCommit.clicks()
        .subscribe {
            viewModel.upLoadUserComment(data, context, showCommentUpLoadProcess())
            dialog.dismiss()
